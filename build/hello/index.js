...
function Edit() {
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Cb Hello Block – hello from the editor!", "cb-my-block")));
}
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./src/hello/style.scss");
...
function save() {
  ...
  }, 'Cb Helo Block – hello from the saved content!');
}
...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"create-block/hello","version":"0.1.0","title":"Cb Hello","category":"widgets","description":"Example block scaffolded with Create Block tool.","example":{},"supports":{"html":false},"textdomain":"cb-my-block","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","viewScript":"file:./view.js"}');
